...
app.post("/try", (req,res) => {
    ...
    try{
        for(var i = 0; i < lt.length; i++){
            ...
            let c_id = req.body[i].id;_groi
            let c_name = req.body[i].nam_groie;
            let c_statecode = req.body[i].sta_groitecode;
            let c_batch = req.body[i].bat_groich;
            let c_lga = req.body[i].lga_groi;
            let c_cds = req.body[i].cds_groi;
