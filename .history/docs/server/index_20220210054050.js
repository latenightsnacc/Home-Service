...
app.post("/newmonthlydues", (req,res) => {
    console.log(req.body);
        let collection_month = a.month;
        let corper_id = a.id;
        let corper_name = a.name;
        let corper_statecode = a.statecode;
        let corper_batch = a.batch;
        let corper_lga = a.lga;
    for(let a in req.body) {
        const collection_month = a.month;
        const corper_id = a.id;
        const corper_name = a.name;
        const corper_statecode = a.statecode;
        const corper_batch = a.batch;
        const corper_lga = a.lga;
    }
