...
app.post("/try", (req,res) => {
    ...
    try{
        for(var i = 0; i < lt.length; i++){
            ...
            let c_id = req.body[i].id;_gro
            let c_name = req.body[i].nam_groe;
            let c_statecode = req.body[i].sta_grotecode;
            let c_batch = req.body[i].bat_groch;
            let c_lga = req.body[i].lga_gro;
            let c_cds = req.body[i].cds_gro;
