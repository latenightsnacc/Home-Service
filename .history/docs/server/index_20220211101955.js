...
app.post("/try", (req,res) => {
    ...
    try{
        for(var i = 0; i < lt.length; i++){
            ...
            try{
                db.query('INSERT INTO dues_collection (collection_date,collection_month,collection_year,amount_paid,corper_idcorper_name	corper_statecode	corper_batch	corper_lga	cds_group) VALUES(?,?,?,?,?,?,?,?,?,?,?,?)',
