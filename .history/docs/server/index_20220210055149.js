...
app.post("/newmonthlydues", (req,res) => {
    console.log(req.body);
        try {
            const newTable = "CREATE TABLE e-attendance.demo ( corper_id INT NOT NULL , corper_name TEXT NOT NULL , corper_statecode` TEXT NOT NULL , `corper_batch` TEXT NOT NULL , `corper_lga` TEXT NOT NULL , `monthly_dues` TEXT NOT NULL , `month` TEXT NOT NULL , PRIMARY KEY (`corper_id`))";
