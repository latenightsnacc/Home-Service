...
app.post("/trynew", (req,res) => {
    ...
    try{
        for(var i = 0; i <= lt; i++){
            ...
            db.query('INSERT INTO attendance (cds_group,corper_id,corper_name,corper_statecode,corper_batch,corper_lga,collection,dues,amount_paid,month,year) VALUES(?,?,?,?,?,?,?,?,?,?,?)',
