...
app.post("/try", (req,res) => {
    ...
    try{
        for(var i = 0; i < lt.length; i++){
            ...
            let c_id = req.body[i].id;_gr
            let c_name = req.body[i].nam_gre;
            let c_statecode = req.body[i].sta_grtecode;
            let c_batch = req.body[i].bat_grch;
            let c_lga = req.body[i].lga_gr;
            let c_cds = req.body[i].cds_gr;
