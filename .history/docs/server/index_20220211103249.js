...
app.post("/try", (req,res) => {
    ...
    try{
        for(var i = 0; i < lt.length; i++){
            ...
            console.log([collection_date,collection_month,collection_year,collection_for,a_paid,c_id,c_name,c_statecode,c_batch,c_lga,c_cds,a_type,c_attendance,comment]);
            try{
