...
app.post("/trynew", (req,res) => {
    ...
    try{
        for(var i = 0; i <= lt; i++){
            ...
            let a_month = req.body[i].attendance_date;
            let a_year = req.body[i].attendance_date;
            let c_id = req.body[i].attendance_date;
            let c_name = req.body[i].attendance_date;
            let acdate = req.body[i].attendance_date;
            let a_date = req.body[i].attendance_date;
            let a_date = req.body[i].attendance_date;
            let a_date = req.body[i].attendance_date;
            let a_date = req.body[i].attendance_date;
