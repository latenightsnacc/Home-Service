...
app.post("/monthlyDues", (req,res) => {
    ...
    try{
        for(var i = 0; i < lt.length; i++){
            ...
            try{
                db.query('INSERT INTO monthly_dues (date_recorded,month,year,payment_status,amount_paid,corper_id,corper_name,corper_statecode,corper_batch,corper_lga,corper_cds) VALUES(?,?,?,?,?,?,?,?,?,?,?) ON DUPLICATE KEY UPDATE lastchannel=?;',
