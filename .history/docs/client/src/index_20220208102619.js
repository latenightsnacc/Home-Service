...
import MonthlyDues from './dashboard/treasurer/MonthlyDues';
import Project from './dashboard/treasurer/Project';
import Events from './dashboard/treasurer/Events';
import Report from './dashboard/treasurer/Report';
import Reports from './dashboard/treasurer/Reports';
  ...
  <React.StrictMode>
    <Router>
      <Routes>
        ...
        <Route path="/dashboard/treasurer/monthlyDues" element={<Treasurer />} />
        <Route path="/dashboard/treasurer/project" element={<Treasurer />} />
        <Route path="/dashboard/treasurer/events" element={<Treasurer />} />
        <Route path="/dashboard/treasurer/account" element={<Treasurer />} />
        <Route path="/dashboard/treasurer/new" element={<Treasurer />} />
