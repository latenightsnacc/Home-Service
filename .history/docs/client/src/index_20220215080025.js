  ...
  <React.StrictMode>
    <Router>
      <Routes>
        ...
        <Route path="/dashboard/secretarygeneral/notes/:year/:month" element={<MonthlyAttendance />} />
        <Route path="/dashboard/secretarygeneral/notes/:minuteId" element={<WeeklyAttendance />} />
