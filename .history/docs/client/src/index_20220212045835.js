  ...
  <React.StrictMode>
    <Router>
      <Routes>
        ...
        <Route path="/dashboard/secretarygeneral/: minutesId" element={<Minutes />} />
        ...
        <Route path="/dashboard/treasurer/monthlydueslist" element={<MonthlyDues />} />
        <Route path="/dashboard/treasurer/dues/:duesId" element ={<Dues />} />
