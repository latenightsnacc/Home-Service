    ...
    return(
        <>
           ...
           <Layout>
               ...
               <Spacer />
               <Container>
                   <div className="flex mx-auto w-full justify-between md:w-4/6 bg-red-400 flex-row items-center">
                        <div className={`text-gray-300 text-xs text-semibold no-underline hover:cursor-pointer hover:no-underline p-2 hover:text-green-500`}>
