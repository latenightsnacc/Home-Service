           ...
           <Layout>
               ...
               <Container>
                   ...
                   <div className="lg:ml-20 max-w-sm md:max-w-lg py-2 px-3 rounded h-20 flex flex-col  justify-center md:flex-row md:justify-start md:items-center shadow-sm my-3">
                        ...
                        <span className="text-xs md:mr-2 py-1 px-2  w-auto rounded md:bg-green-100 ">{(new Date()).toLocaleDateString('en-US',{
                                weekday: 'short',
                                day: 'numeric',
                                year: 'numeric',
                                month: 'short'
                   ...
                   <div className="lg:ml-20 max-w-sm md:max-w-lg py-2 px-3 rounded h-20 flex flex-col  justify-center md:flex-row md:justify-start md:items-center shadow-sm my-3">
                        ...
                        <span className="text-xs md:mr-3 py-1 px-2  w-32 rounded md:bg-green-100 ">{(new Date()).toLocaleDateString('en-US',{
                                weekday: 'short',
                                day: 'numeric',
                                year: 'numeric',
                                month: 'short'
