    ...
    return(
        <>
           ...
           <Layout>
               ...
               <Container>
                   <MiniLayout>
                   <div className="md:ml-20 max-w-sm md:max-w-lg py-2 px-3 rounded h-20 flex items-center shadow-sm my-3">
                       <span className="text-green-400"><i class="fa-solid fa-square-check"></i></span>
                        <span className="text-xs mx-3">{(new Date()).toLocaleDateString('en-US',{
                                weekday: 'short',
                                day: 'numeric',
                                year: 'numeric',
                                month: 'short'
                            })}:</span>
                        <span className="text-sm"> Attendance <span className="text-green-400">['Present']</span> for CDS Meeting recorded.</span>
                    </div>
                   </MiniLayout>
