    ...
    return(
        <>
           ...
           <Layout>
               ...
               <Container>
                   <MiniLayout>
                   <div className="w-full lg:pl-20 py-2 px-1 md:pl-20 rounded h-20 flex flex-col  justify-center md:flex-row md:justify-start md:items-center shadow-sm my-3">
                   ...
                   <div className="lg:px-20 w-full py-2 px-1  rounded h-20 flex flex-col  justify-center md:flex-row md:justify-start md:items-center shadow-sm my-3">
