        ...
        <div>
            ...
            <div className="w-full md:w-5/6 md:mx-auto">
                ...
                <Stats  
                    ...
                    totalFigure2={`₦${mDuesTotal}`} totalTitle2={"Total Meetings"} 
                    totalFigure3={`₦${pDuesTotal}`} totalTitle3={"Total Events"} 
                    totalFigure4={`₦${eDuesTotal}`} totalTitle4={"Total Fees Collected"}
                />
                <Spacer />
            </div>
            <Footer />
