    ...
    return(
        <>
           ...
           <Layout>
               ...
               <Container>
                   <div className="flex ml-auto w-full text-xs md:text-sm lg:text-base justify-between md:justify-start md:w-4/6 lg:w-5/6 bg-red-400 flex-row items-center">
                        <div className={`text-gray-300 text-semibold no-underline hover:cursor-pointer hover:no-underline p-2 hover:text-green-500 lg:mr-`}>
