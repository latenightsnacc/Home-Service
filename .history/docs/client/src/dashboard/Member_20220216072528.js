    ...
    return(
        <>
           ...
           <Layout>
               ...
               <Container>
                   <MiniLayout>
                   <div className=" bg-gray-100 w-full py-2 sm:ml  md:pl-20 rounded h-20 flex flex-col  justify-center md:flex-row md:justify-start md:items-center shadow-sm my-3">
