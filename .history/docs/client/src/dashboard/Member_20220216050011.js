           ...
           <Layout>
                ...
                <div className="flex flex-row items-center justify-center">
                    ...
                    <div className="ml-5 md:ml-10 ">
                        ...
                        <div className="flex flex-col text-sm text-gray-700 md:text-base">
                            ...
                            <span className="text-xs font-medium  md:text-sm">{(new Date()).toLocaleDateString('en-US',{
                                weekday: 'long',
                                day: 'numeric',
                                year: 'numeric',
                                month: 'short'
               ...
               <Container>
                   <div className="flex mx-auto w-full text-xs md:text-sm lg:text-base justify-around flex-row items-center md:w-4/6 lg:w-5/6 border-y border-y-green-400  md:pl-5">
                        <div className={`text-green-400 no-underline hover:cursor-pointer hover:no-underline p-2 hover:text-green-500 lg:mr-5`}>
