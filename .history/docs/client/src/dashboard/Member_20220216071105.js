    ...
    return(
        <>
           ...
           <Layout>
               ...
               <Container>
                   <MiniLayout>
                   <div className="lg:ml-20  bg-gray-100 w-full py-2 px-3 rounded h-20 flex flex-col  justify-center md:flex-row md:justify-start md:items-center shadow-sm my-3">
