           ...
           <Layout>
               ...
               <Container>
                   ...
                   <div className="lg:ml-20 max-w-sm md:max-w-lg py-2 px-3 rounded h-20 flex flex-col  justify-center md:flex-row md:justify-start md:items-center shadow-sm my-3">
                        ...
                        <span className="text-xs mrmd:mr-3 p-2 w-32 rounded bg-green-100">{(new Date()).toLocaleDateString('en-US',{
                                weekday: 'short',
                                day: 'numeric',
                                year: 'numeric',
                                month: 'short'
                            })}</span>
                        <span className="text-xs md:mt-0 md:text-sm"> Attendance ['<span className="text-green-400"> Present </span> '] for CDS Meeting recorded.</span>
                    </div>
                   </MiniLayout>
