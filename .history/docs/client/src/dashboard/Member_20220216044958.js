    ...
    return(
        <>
           ...
           <Layout>
               ...
               <Container>
                   <div className="flex ml-auto w-full text-xs md:text-sm lg:text-base justify-around md:justify-start md:w-4/6 lg:w-5/6 shadow-sm border-t-1 borde flex-row items-center md:pl-5">
