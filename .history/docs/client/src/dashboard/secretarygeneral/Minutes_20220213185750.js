                    ...
                    <Container>
                        ...
                        <div className="flex flex-col md:flex-row items-center">
                            <div className="flex w-full  border-1 border-success py-2  px-3 rounded flex-row items-center text-xs">
                                <span className="rounded py-1 px-3 bg-green-100 text-gray-800 ">{results[0].type}</span>            
                            </div>
                            <div className="my-2 md:my-0 md:ml-3">
                                <span className="rounded py-1 px-3 bg-green-100 text-gray-800 ">{new Date(results[0].date).toUTCString}</span>
                            </div> 
                        </div>
                        <div className="flex border-1 border-success rounded flex-row items-center text-xs mb-2 md:mb-0">
                                <div className="flex flex-row items-center">
                                    <label className="ml-2" for={"start"}>Start:</label>
                                        <span className="rounded py-1 px-3 bg-green-100 text-gray-800 ">{results[0].start_time}</span>    
                                    </div>
                                <div className="flex flex-row items-center ml-2">
                                    <label className="ml-2" for={"end"}>End</label>
                                        <span className="rounded py-1 px-3 bg-green-100 text-gray-800 ">{results[0].end_time}</span>     
                                    </div>            
                                </div>               
                        </div>
