...
const RecordAttendance = () => {
    ...
    if (error) return 'error';
      ...
      const getValues = (e) => {
        e.preventDefault();
          setData({
              attendance_date: e.t('date').value,
              corper_id: e.t('id').value,
              corper_name: e.t('name').value,
              corper_batch: e.t('batch').value,
              corper_statecode: e.t('statecode').value,
              corper_attendance: attendance[0],
              corper_comment: e.t('comment').value
          })
