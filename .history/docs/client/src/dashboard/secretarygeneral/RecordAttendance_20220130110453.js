                                ...
                                <tr className="h-8">
                                    ...
                                    <th scope="col" className="text-left">
                                        <div className="flex flex-row justify-center items-center text-right">
                                            <span className="block w-3 h-3 bg-green-400"></span><span className="ml-2 capitalize hidden md:inline">present</span>
                                        </div>
                                    </th>
                                    <th scope="col" className="text-left">
                                        <div className="flex flex-row justify-center items-center text-right">
                                            <span className="block w-3 h-3 bg-yellow-300"></span><span className="ml-2 capitalize hidden md:inline">late</span>
                                        </div>
                                    </th>
                                    <th scope="col" className="text-left">
                                        <div className="flex flex-row justify-center items-center">
                                            <span className="block w-3 h-3 bg-red-300"></span><span className="ml-2 capitalize hidden md:inline">absent</span>
                                        </div></th>
                                ...
                                <tr>
                                    ...
                                    <td className="text-center">
                                        <input 
                                            ...
                                            id="present"
                                            value={"present"} 
                                            className="hover:text-green-400 focus:text-green-400 focus:no-outline checked:text-green-400 checked:border-2 checked:border-green-400" />
                                    </td>
                                    <td>
                                        <div className="flex flex-row items-center justify-center">
                                            <input type="checkbox" className="rounded checked:bg-green-700 checked:border-1 checked:border-green-700" />
                                        </div>
                                    </td>
                                    <td>
                                        <div className="flex flex-row items-center justify-center">
                                    ...
                                    <td>
                                        <div className="flex flex-row items-center justify-center">
                                            <input type="text" className="border-0 focus:border-1 focus:outline-none focus:border-green-500 w-full h-7" />
                                        </div>
                                    </td>
                                </tr>                                
                            </tbody>
