...
const Attendance = () => {
    ...
    mValues.map(a => {
        if(a.length > 0){
            ...
            a.map(b => {
                if(b.attendance_status === "present" || b.attendance_status === "late") {
                    totalAttendees()
                }
                else if(b.attendance_status === "present"){
                    attendees.push(1)
    ...
    lateAttendees.length > 0 ?  lateAttendeesTotal = attendees.reduce( (a,b) => {return a + b }): lateAttendeesTotal = 0;                     
    absentees.length > 0 ? absenteesTotal = attendees.reduce( (a,b) => {return a + b }) : absenteesTotal = 0;                     
