                                ...
                                <tr className="h-8">
                                    ...
                                    <th scope="col" className="text-left">
                                        <div className="flex flex-row justify-center items-center text-right">
                                            <span className="block w-4 h-4 bg-green-400"></span><span className="ml-2 capitalize hidden md:inline">present</span>
                                        </div>
                                    </th>
                                    <th scope="col" className="text-left">
                                        <div className="flex flex-row justify-center items-center text-right">
                                            <span className="block w-4 h-4 bg-yellow-300"></span><span className="ml-2 capitalize hidden md:inline">late</span>
                                        </div>
                                    </th>
                                    <th scope="col" className="text-left">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div className="flex flex-row h-8 items-center justify-center">
                                            <input type="checkbox" className="rounded-full no-outline checked:bg-green-700 checked:border-2 checked:border-green-700" />
                                        </div>
                                    </td>
                                    <td>
                                        <div className="flex flex-row h-8 items-center justify-center">
