      ...
      const getValues = (e) => {
        ...
        setAttendance({
          ...
          setData({
              ...
              corper_id: document.getElementById('id').value,
              corper_name: document.getElementById('name').value,
              corper_batch: document.getElementById('batch').value,
              corper_statecode: document.getElementById('statecode').value,
              corper_attendance: attendance.a,
              corper_comment: document.getElementById('comment').value
          })
          console.log(`Values: ${data.corper_attendance}`);
