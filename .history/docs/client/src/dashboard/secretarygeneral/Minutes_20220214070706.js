        ...
        <>
            ...
            <Layout>
                ...
                <BreadCrumbs
                    ...
                    /> 
                <Spacer />
                    <PageTitle title={`Minutes for ${min.type} on the ${(new Date(min.date)).toLocaleDateString('en-US',{
                        weekday: 'short'
                    })}`} />
                </Container>
                <form className="mt-2">
                    <Container>
                        ...
                        <div className="flex flex-row w-full justify-between my-1 items-center">
                            ...
                            <div className="flex w-full text-xs md:text-sm flex-row justify-end text-right my-2 items-center">
