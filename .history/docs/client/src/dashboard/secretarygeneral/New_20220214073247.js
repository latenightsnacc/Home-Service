            ...
            <form onSubmit={createNote}>
                <Container>
                    ...
                    <input
                      ...
                      <div className="flex border-1 border-success rounded justify-between flex-row items-center text-xs mb-2 md:mb-0">
                                <div className="flex flex-row items-center">
                                <label className="mr-2" for={"start"}>Start:</label>
                                    <input
                                        type={"time"}
                                        id="start"
                                        name="start"
                                ...
                                <div className="flex flex-row items-center justify-end text-right ml-2">
                                <label className="mr-2" for={"end"}>End</label>
                                    <input
                                        type={"time"}
                                        id="end"
                                        name="end"
