                        ...
                        <table className="table table-sm table-auto table-bordered border-success table-hover text-xs md:text-sm bg-white rounded">
                            ...
                            <tbody className="font-light">
                                <tr>
                                    ...
                                    <td className="inline-block flex flex-row items-center justify-center">
                                        <input type="text" className="border-0 rounded focus:border-1 focus:outline-none focus:border-green-500 w-full h-3 p-1" />
                                    </td>
                                </tr>                                
                            </tbody>
                        </table>
