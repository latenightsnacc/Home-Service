                ...
                <Container>
                    ...
                    <div className="w-full flex flex-col-reverse md:flex-row md:items-center my-3 md:justify-between">
                        <div className="flex border-1 border-success py-2 px-3 rounded flex-row items-center text-xs">
                                ...
                                <label className="ml-2" for={"end"}>End</label>
                                    <input
                                        ...
                                        className="border-0 rounded-lg ring-0 focus:outline-0 focus:ring-0 checked:text-green-400"
                                        onChange={getDetails}
                                    /> 
                        ...
                        <input
                            ...
                            id={"venue"}
                            name={"venue"} 
                            className="form-input my-2 md:my-0 h-8 w-full md:w-1/2 text-xs font-medium md:text-sm border-1 border-success focus:border-0 py-2 px-3 focus:outline-none"
                            onChange={getDate}
                            />                  
                    </div>
