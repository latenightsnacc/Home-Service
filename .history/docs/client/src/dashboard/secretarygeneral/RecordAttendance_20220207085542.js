      ...
      const getValues = (e) => {
        e.preventDefault();
          ...
          setData({
              ...
              corper_id: document.getElementById('date).value,
              corper_name: document.getElementById('date').value,
              corper_batch: document.getElementById('date').value,
              corper_statecode: document.getElementById('date').value,
