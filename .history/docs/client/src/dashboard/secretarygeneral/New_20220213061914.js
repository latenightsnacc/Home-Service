            ...
            <form onSubmit={createNote}>
                <Container>
                    ...
                    <input
                        ...
                        id={"date"}
                        name={"date"} 
                        className="form-input my-2 md:my-0 md:ml-3 h-8 w-full md:w-auto text-xs font-medium md:text-sm border-1 border-success focus:border-0 py-2 px-3 focus:outline-none"
                        onChange={getDate}
                        />  
                      </div>
