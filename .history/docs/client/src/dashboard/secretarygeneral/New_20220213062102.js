            ...
            <form onSubmit={createNote}>
                <Container>
                    ...
                    <input
                        ...
                        id={"date"}
                        name={"date"} 
                        className="form-input my-2 md:my-0 md:ml-3 w-full md:w-auto text-xs font-normal rounded md:text-sm border-1 border-success focus:border-0 p px-3 focus:outline-none"
                        onChange={getDate}
                        />  
                      </div>
