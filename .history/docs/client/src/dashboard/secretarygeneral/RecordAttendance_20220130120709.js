                                    ...
                                    <tr className='hover:bg-white hover:text-green-500' key={val.id}>
                                        <td>
                                            <input 
                                                ...
                                                id="id"
                                                value={val.id}
                                                className="border-0 rounded focus:border-1 focus:outline-none focus:border-green-500 w-auto"
                                                onChange={getDetails}
                                                readOnly 
                                                />
                                        </td>
                                        ...
                                        <td >
                                            <input 
                                                ...
                                                className="border-0 rounded focus:border-1 focus:outline-none focus:border-green-500 w-28"
                                                onChange={getDetails} />
                                        </td>
                                        <td className="hidden md:table-cell">
                                            <input 
