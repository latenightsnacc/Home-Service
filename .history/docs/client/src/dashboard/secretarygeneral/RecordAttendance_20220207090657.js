...
const RecordAttendance = () => {
    ...
    if (error) return 'error';
      ...
      const getValues = (e) => {
        e.preventDefault();
          setData({
              attendance_date: e.ta('date').value,
              corper_id: e.ta('id').value,
              corper_name: e.ta('name').value,
              corper_batch: e.ta('batch').value,
              corper_statecode: e.ta('statecode').value,
              corper_attendance: attendance[0],
              corper_comment: e.ta('comment').value
          })
