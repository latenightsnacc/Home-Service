                ...
                <form onSubmit={recordAttendance}>
                    ...
                    <div className="container">
                        <table className="table table-sm table-auto table-bordered border-success table-hover text-xs md:text-sm bg-white rounded">
                                ...
                                {list.map(val => {
                                return (
                                    <tr className='text-xs hover:bg-white hover:text-green-500' key={val.id}>
                                        <td className="text-left">
                                            <input 
                                                ...
                                                id="id"
                                                value={val.id}
                                                className="text-xs md:text-sm border-0 rounded focus:border-1 focus:outline-none focus:border-green-500 w-8"
                                                onChange={getDetails}
                                                readOnly 
                                                />
                                        </td>
                                        <td className="hidden md:table-cell">
                                            <input 
                                                ...
                                                id="name"
                                                value={val.name}
                                                className="text-xs md:text-sm border-0 rounded focus:border-1 focus:outline-none focus:border-green-500 w-full"
                                                onChange={getDetails} />
                                        </td>
                                        <td >
                                            <input 
                                                ...
                                                className="text-xs md:text-sm border-0 rounded focus:border-1 focus:outline-none focus:border-green-500 w-32"
                                                onChange={getDetails} />
                                        </td>
                                        <td className="hidden md:table-cell">
                                            <input 
                                                ...
                                                id="batch"
                                                value={val.batch}
                                                className="text-xs md:text-sm border-0 rounded focus:border-1 focus:outline-none focus:border-green-500 w-20"
                                                onChange={getDetails} />
                                        </td>
                                        ...
                                        <td className="inline-block flex flex-row items-center justify-center text-sm">
                                            ...
                                            name="comment"
                                            id="comment"
                                            value={newAttendance.id.comment}
                                            className="text-xs md:text-sm border-0 rounded focus:border-1 focus:outline-none focus:border-green-500 w-full h-7 p-2"
                                            onChange={getDetails} />
                                        </td>
                                    </tr>
                                )
