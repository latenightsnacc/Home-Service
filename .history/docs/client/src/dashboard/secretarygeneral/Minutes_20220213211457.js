    ...
    return( 
        <>
            ...
            <Layout>
                ...
                <Spacer />
                <Container>
                    <PageTitle title={`Minutes for ${min.type}`} />
                </Container>
                <form className="mt-2">
                    <Container>
                        ...
                        <div className="flex flex-row w-full justify-between my-1 items-center">
                            ...
                            <div className="flex flex-row text-right my-2 px-3 items-center">
                                    <label className="mr-1" for={"start"}>Date:</label>
                                    <span className="rounded py-1">{min.date}</span>    
                                </div>
                        </div>
