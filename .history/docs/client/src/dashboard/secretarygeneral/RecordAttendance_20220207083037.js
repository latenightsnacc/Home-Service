...
const RecordAttendance = () => {
    ...
    //   }
      ...
      const getValues = () => {
          ...
          vals.push(date,name,batch,statecode,comment);
        console.log(vals);
      }
      var rr = [];
                ...
                <form onSubmit={recordAttendance} class="er">
                    <div className="container text-gray-800">
                        <div className="flex flex-row items-center justify-between">
                            ...
                            <div className="flex">
                            <button onClick={getVals} type="submit" className="my-1 mr-1 lg:mr-2 inline-block px-3 py-2 rounded tracking-wide text-gray-800 bg-gray-100 bg-opacity-50 hover:bg-green-100 text-xs text-left md:text-right md:text-sm capitalize shadow-sm flex items-center">
