            ...
            <form onSubmit={createNote}>
                <Container>
                    <div className="w-full flex flex-col-reverse md:flex-row md:items-center  md:justify-between">
                      ...
                      <div className="flex border-1 border-success py-2  px-3 rounded flex-row items-center text-sm">
                    ...
                    <input
                        ...
                        id={"date"}
                        name={"date"} 
                        className="form-input my-2 md:my-0 md:ml-3 w-full md:w-auto text-xs font-normal rounded md:text-sm border-1 border-success focus:border-0  px-3 focus:outline-none"
                        onChange={getDate}
                        />  
                      </div>
