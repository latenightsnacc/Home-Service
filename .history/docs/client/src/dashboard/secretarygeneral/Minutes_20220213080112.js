        ...
        <>
            ...
            <Layout>
                ...
                <Container>
                    ...
                    <span className="rounded py-1 px-3 bg-green-100 text-gray-800 ">{results.venuw</span>
                    </div>
                    <input
                            type={"text"}
                            id={"venue"}
                            ...
                            placeholder={"Venue"}
                            value={newNote.venue} 
                            className="form-input  rounded w-full text-xs font-medium md:text-sm border-1 border-success focus:border-0   fring-0 focus:outline-0 focus:ring-0 "
                            onChange={getDetails}
                            />
                    <div>
                      <input
