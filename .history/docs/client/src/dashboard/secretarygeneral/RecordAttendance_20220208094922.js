...
const RecordAttendance = () => {
    ...
    //   }
      ...
      const get = () => {
        const rows = document.getElementsById('tr');
        for(var i = 1; i <= rows.length; i++){
            ...
            console.log(date,id,name,statecode,batch,comment);
                ...
                <form onSubmit={handleSubmit} class="er">
                    ...
                    <div className="container">
                        <table className="table table-sm table-auto table-bordered border-success table-hover text-xs md:text-sm bg-white rounded">
                                ...
                                {list.map(val => {
                                return (
                                    <tr className='text-xs hover:bg-gray-50 hover:text-green-500' id={val} key={val.id}>
