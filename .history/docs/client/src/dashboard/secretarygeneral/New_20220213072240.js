            ...
            <form onSubmit={createNote}>
                <Container>
                    <div className="w-full flex flex-col-reverse md:flex-row md:items-center  md:justify-between">
                      ...
                      <div className="flex w-full my-1 border-1 border-success py-2  px-3 rounded flex-row items-center text-xs">
                    ...
                    <input
                        ...
                        id={"date"}
                        name={"date"} 
                        className="form-input my-2 md:my-0 md:ml-3 w-full md:w-auto text-xs font-normal rounded  border-1 border-success focus:border-0  px-3 focus:outline-none"
                        onChange={getDate}
                        />  
                      </div>
                    ...
                    <input
                            ...
                            placeholder={"Venue"}
                            value={newNote.venue} 
                            className="form-input  rounded w-full text-xs font-medium md:text-sm border-1 border-success focus:border-0 py-2 px-3  focus:outline-none"
                            onChange={getDetails}
                            />
                    <div>
                      <input
                        ...
                        value={newNote.topic}
                        className={`${topic.display} form-input my-2 md:my-0 rounded w-full text-xs font-medium md:text-sm border-1 border-success focus:border-0 py-2 px-3  focus:outline-none`}
                        onChange={getDetails}
                        />
                      </div> 
                    ...
                    id="minutes"
                    type="text"
                    className="border-1 text-xs md:text-sm rounded mt-2 w-full h-96 p-3 focus:outline-none"
