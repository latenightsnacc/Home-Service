...
import { CLIENT_MULTI_RESULTS } from "mysql/lib/protocol/constants/client";
                ...
                <form onSubmit={trySending} className="">
                    <div className="w-full flex flex-row items-center my-3 justify-between">
                        <input
                            ...
                            id={"date"}
                            name={"date"} 
                            className="form-input h-8 text-xs font-medium md:text-sm border-1 border-success focus:border-0 py-2 px-3 focus:outline-none"
                            onChange={getDate}
                            />
                        <div className="">
                            <label></label>
                            <input
                                ...
                                className="form-input text-xs font-medium md:text-sm border-1 active:border-success focus:border-success py-2 px-3 focus:outline-none"
                                onChange={''}
                                />
                        </div> 
                    ...
                    <table className="table table-sm table-bordered border-success table-hover text-xs md:text-sm bg-white rounded">
                        <thead>
                            <tr>
                                ...
                                <tr className='text-xs md:text-sm font-medium hover:bg-white hover:text-green-500' id={val.id} key={val.id}>
                                    ...
                                    <td className="text-center">
                                        <input 
                                            ...
                                            id={"paid"}
                                            value={"paid"} 
                                            className="form-checkbox hover:text-green-400 focus:text-green-400 focus:no-outline checked:text-green-400 focus:border-0"
                                            onChange={paidDues}
                                            />
                                    </td>
                                    <td className="text-center">
                                        <input 
                                            ...
                                            id={"not-paid"}
                                            value={"not-paid"} 
                                            className="form-checkbox hover:text-green-400 focus:text-green-400 focus:no-outline checked:text-green-400 checked:border-0"
                                            onChange={paidDues}
                                            />
                                    </td>
                                    <td className="text-left">
                                        <input 
                                            ...
                                            name={`amount_${val.id}`}
                                            id={`amount_${val.id}`} 
                                            className="form-input w-14 h-7 p-2 rounded border-0 focus:border-0 focus:ring-0 focus:no-outline "
                                            onChange={getAmount}
                                            />
                                    </td>
