...
const NewCollection = () => {
  ...
  const createMonthly = (e) => {
    e.preventDefault();
    try {
      Axios.post("http://localhost:3001/new", {
        type: newMonthly.type,
        date: newMonthly.date,
        start: newMonthly.start,
        end: newMonthly.end,
        venue: newMonthly.venue,
        topic: newMonthly.topic,
        minutes: newMonthly.minutes
      }).then( (Response) => {
    ...
    return(
        ...
        <div className="w-full md:w-5/6 md:mx-auto">
                <form onSubmit={createMonthly} class="er">
