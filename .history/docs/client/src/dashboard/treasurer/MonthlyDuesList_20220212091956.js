        ...
        <>
            ...
            <Layout>
                ...
                <div className="flex flex-row h-full items-center justify-between">
                    ...
                    <Link to={"/dashboard/treasurer/newmonthlydues"}>
                        <Button label="record new" icon={<button  type="submit" className="my-1 mr-1 lg:mr-2 inline-block px-3 py-2 rounded tracking-wide text-gray-800 bg-gray-100 bg-opacity-50 hover:bg-green-100 text-xs text-left md:text-right md:text-sm capitalize shadow-sm flex items-center">
            <span><i className={`fas fa-save`}`></i></span><span className="hidden md: ml-1 md:inline-block">{props.label}</span>
        </button>} />
                    </Link>
