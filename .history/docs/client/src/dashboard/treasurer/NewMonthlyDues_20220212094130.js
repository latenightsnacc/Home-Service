        ...
        <Layout>
            ...
            <Container>
                <form onSubmit={trySending}>
                    <div className="w-full flex flex-row items-center bg-red-400 justify-between">
                        <div className="flex flex-row  ml-3 items-center ">
                            ...
                            id={"date"}
                            name={"date"} 
                            className="form-input h-8 text-xs font-medium md:text-sm border-0 focus:border-0 py-2 px-3 focus:outline-none"
                            onChange={getDate}
                            />  
                        </div>
                        <Button label={"Save"} icon={"fas fa-save"} />
                    </div>
                    <table className="table table-bordered border-success table-hover text-xs md:text-sm bg-white rounded">
                        <thead>
                            <tr>
