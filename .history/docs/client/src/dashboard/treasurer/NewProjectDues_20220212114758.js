    ...
    return(
        ...
        <Layout>
            ...
            <form onSubmit={trySending} className="">
                <div className="w-full flex flex-row items-center my-3 justify-between"></div>
                    ...
                    <div className="w-full flex flex-row items-center my-3 justify-between">
                        ...
                        <div className="">
                            ...
                            <input
                                ...
                                className="form-input text-xs font-medium md:text-sm p-2 rounded border-0 focus:border-0 focus:ring-0 focus:outline-0"
                                onChange={''}
                                />
                        </div> 
