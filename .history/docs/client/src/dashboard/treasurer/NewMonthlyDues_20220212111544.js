                                ...
                                <tr className='text-xs md:text-sm font-medium hover:bg-white hover:text-green-500' id={val.id} key={val.id}>
                                    ...
                                    <td className="text-center">
                                        <input 
                                            ...
                                            id={"paid"}
                                            value={"paid"} 
                                            className="form-checkbox mt-2 hover:text-green-400 focus:text-green-400 focus:no-outline checked:text-green-400 focus:border-0  "
                                            onChange={paidDues}
                                            />
                                    </td>
                                    <td className="text-center">
                                        <input 
                                            ...
                                            id={"not-paid"}
                                            value={"not-paid"} 
                                            className="form-checkbox mt-2 hover:text-green-400 focus:text-green-400 focus:no-outline checked:text-green-400 checked:border-0"
                                            onChange={paidDues}
                                            />
                                    </td>
                                    <td className="text-left">
                                        <input 
                                            ...
                                            name={`amount_${val.id}`}
                                            id={`amount_${val.id}`} 
                                            className="form-input w-14 p-2 rounded border-0 focus:border-0 focus:ring-0 focus:no-outline "
                                            onChange={getAmount}
                                            />
                                    </td>
