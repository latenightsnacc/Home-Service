                                ...
                                <tr className='text-xs md:text-sm font-medium hover:bg-white hover:text-green-500' id={val.id} key={val.id}>
                                    ...
                                    <td className="text-center">
                                        <input 
                                            ...
                                            id={"paid"}
                                            value={"paid"} 
                                            className="form-checkbox mt-2 hover:text-green-400 focus:text-green-400 focus:no-outline checked:text-green-400 focus:border-0 checked:border-yellow-400 "
                                            onChange={paidDues}
                                            />
                                    </td>
                                    <td className="text-center">
