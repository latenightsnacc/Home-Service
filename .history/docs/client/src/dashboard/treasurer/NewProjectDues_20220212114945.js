            ...
            <form onSubmit={trySending} className="">
                <div className="w-full flex flex-row items-center my-3 justify-between">
                    ...
                    <div className="flex flex-row">
                            <label for={"project_batch"}>Batch:</label>
                            <input
                                type={"text"}
                                id={'project_batch'}
                                name={"project_batch"} 
                                placeholder={'Batch A 2021'}
                                className="form-input text-xs w-24 font-medium md:text-sm p-2 rounded border-success border-1 focus:border-1 focus:ring-0 focus:outline-0"
                                onChange={''}
                                />
                        </div> 
                </div>
