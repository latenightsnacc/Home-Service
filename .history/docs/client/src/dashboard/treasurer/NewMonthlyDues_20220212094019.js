                ...
                <form onSubmit={trySending}>
                    <div className="w-full flex flex-row items-center bg-red-400 justify-between">
                        <div className="flex flex-row  ml-3 items-center ">
                            ...
                            id={"date"}
                            name={"date"} 
                            className="form-input h-8 border-0 focus:border-0 py-2 px-3 focus:outline-none"
                            onChange={getDate}
                            />  
                        </div>
                                ...
                                <tr className='text-xs md:text-sm font-medium hover:bg-gray-50 hover:text-green-500' id={val.id} key={val.id}>
                                    ...
                                    <td className="text-left">
                                        <input 
                                            ...
                                            name={`amount_${val.id}`}
                                            id={`amount_${val.id}`} 
                                            className="form-input w-18 p-2 rounded border-0 focus:border-0 focus:ring-0 focus:no-outline "
                                            onChange={getAmount}
                                            />
                                    </td>
