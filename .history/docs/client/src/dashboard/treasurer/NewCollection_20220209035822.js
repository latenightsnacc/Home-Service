  ...
  const createCollection = (e) => {
    ...
    return(
        ...
        <div className="w-full md:w-5/6 md:mx-auto">
                <form onSubmit={createCollection} class="er">
                                    ...
                                    <tr className='text-xs hover:bg-gray-50 hover:text-green-500' key={val.id}>
                                        ...
                                        <td className="hidden md:table-cell">
                                            <input 
                                                ...
                                                id="batch"
                                                value={val.batch}
                                                className="text-xs bg-transparent md:text-sm border-0 rounded  focus:outline-none focus:border-green-500 w-20"
                                                readOnly 
                                                />
                                        </td>
                                        <td className="text-center ">
                                            <input 
                                                ...
                                                id="lga"
                                                value={val.lga} 
                                                className="text-xs bg-transparent md:text-sm border-0 rounded  focus:outline-none focus:border-green-500 w-auto"
                                                onChange={getDetails} />
                                        </td>
                                        <td className="text-center">
                                            <input 
