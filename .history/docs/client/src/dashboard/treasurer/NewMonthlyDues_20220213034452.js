                ...
                <form onSubmit={trySending} className="">
                    <div className="w-full flex flex-row items-center my-3 justify-between">
                        <input
                            ...
                            id={"date"}
                            name={"date"} 
                            className="form-input h-8 w-full md:w-auto text-xs font-medium md:text-sm border-1 border-success focus:border-0 py-2 px-3 ring-0 focus:outline-0 focus:ring-0"
                            onChange={getDate}
                            /> 
                                ...
                                <tr className='text-xs md:text-sm font-medium hover:bg-white hover:text-green-500' id={val.id} key={val.id}>
                                    ...
                                    <td className="text-center">
                                        <input 
                                            ...
                                            id={"paid"}
                                            value={"paid"} 
                                            className="form-checkbox hover:text-green-400 focus:text-green-400 ring-0 focus:outline-0 focus:ring-0 checked:text-green-400 focus:border-0"
                                            onChange={paidDues}
                                            />
                                    </td>
                                    <td className="text-center">
                                        <input 
                                            ...
                                            id={"not-paid"}
                                            value={"not-paid"} 
                                            className="form-checkbox hover:text-green-400 focus:text-green-400 ring-0 focus:outline-0 focus:ring-0 checked:text-green-400 checked:border-0"
                                            onChange={paidDues}
                                            />
                                    </td>
                                    <td className="text-left">
                                        <input 
                                            ...
                                            name={`amount_${val.id}`}
                                            id={`amount_${val.id}`} 
                                            className="form-input w-14 h-7 p-2 font-medium rounded border-0 focus:border-0 fring-0 focus:outline-0 focus:ring-0"
                                            onChange={getAmount}
                                            />
                                    </td>
