...
const NewProjectDues = () => {
    ...
    const [eventTitle, setProjectBatch] = useState('');
    useEffect(() => {
                ...
                <Container>
                    <div className="w-full flex flex-row items-center my-3 justify-between">
                        <input
                            ...
                            className="form-input text-xs w-5/6  md:w-1/2 font-medium md:text-sm p-2 rounded border-success border-1 focus:border-1 focus:ring-0 focus:outline-0"
                            onChange={getBatch}
                        />
