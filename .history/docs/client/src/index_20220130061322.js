...
import New from './dashboard/secretary_general/New';
  ...
  <React.StrictMode>
    <Router>
      <Routes>
        ...
        <Route path="/dashboard/secretary-general/attendance" element={<Attendance />} />
        <Route path="/dashboard/secretary-general/reports" element={<Notes />} />
        <Route path="/dashboard/secretary-general/events" element={<Events />} />
