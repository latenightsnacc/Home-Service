           ...
           <Layout>
               ...
               <Container>
                    ...
                    <form className="w-full md:w-4/6 mx-auto">
                        ...
                        <div className="relative border-1 py-2 mb-4 border-gray-300 rounded text-sm w-full">
                            <div className="absolute -top-3">
                                <label className="text-xs px-2 bg-white text-green-500">Local Government.A</label>
                            </div>
                            <input 
                            type={'text'}
                            placeholder={'Full Name'}
                        ...
                        <div className="relative border-1 py-2 mb-4 border-gray-300 rounded text-sm w-full">
                            ...
                            className={'border-0 text-xs md:text-sm px-2 w-full focus:ring-0 focus:outline-0'} required>
