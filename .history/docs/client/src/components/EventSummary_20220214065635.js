    ...
    return(
        <div className="container my-4">
            <div className="min-w-sm shadow-sm p-2 mt-3 text-xs md:text-sm text-gray-800">
                ...
                <div className=" flex flex-col leading-3 text-gray-700 pt-4 capitalize">
                        <div><span className="mr-1 text-xs font-medium">Topic:</span> <span>{props.topic}</span></div>
                        <div><span className="mr-1 text-xs font-medium">Venue:</span> <span>{props.venue}</span></div>
                    </div>
