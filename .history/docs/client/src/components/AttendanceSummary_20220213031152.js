        ...
        <div className="min-w-sm shadow-sm p-2 mt-3 text-sm text-gray-800">
                ...
                <div className="flex flex-col items-center md:flex-row justify-evenly ">
                    <div className="border-0 hover:text-green-500 rounded by-white flex flex-col items-center p-3">
                        ...
                        <span className="text-xs text-gray-500 font-light">{props.attendeesLabel}</span>
                    </div>
                    <div className="border-0 hover:text-green-500 rounded by-white flex flex-col items-center p-3">
                        <span className="text-lg font-medium">{props.absenteesTotal}</span>
                        <span className="text-xs text-gray-500 font-light">{props.absenteesLabel}</span>
                    </div>
                    <div className="border-0 hover:text-green-500 rounded by-white flex flex-col items-center p-3">
                        <span className="text-lg font-medium">{props.lateAttendeeTotal}</span>
