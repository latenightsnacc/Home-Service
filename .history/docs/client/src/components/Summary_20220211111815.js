    ...
    return(
        <div className="container my-4">
            <div className="min-w-sm shadow-sm p-2 mt-3 text-sm text-gray-800">
                ...
                <p className="py-2 text-gray-500 leading-7">imomi eveniet cum iste minima porro dolore suntofficia laborum ex provident, necessitatibus, cumque a quasi nesciunt aut exercitationem vero id!...</p>        
            </div>
        </div>
    )
}
