            ...
            <Layout>
                <Container>
                    <nav className="flex flex-row justify-between items-center">
                        ...
                        <button 
                        className="text-sm font-light py-2 px-3 md:shadow-sm flex items-center no-underline rounded bg-gray-100 bg-opacity-50 hover:bg-opacity-100 hover:bg-green-500 text-sm text-black hover:text-white flex items-center">
