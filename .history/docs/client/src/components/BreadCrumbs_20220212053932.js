    ...
    return(
        <div className="container mx-auto">
            <ul className="flex felex-row text-xs font-500 text-gray-300">
                ...
                <Link to={`/dashboard/${props.excoDashboard}/${props.excoPage}/${props.finalPage}`}>
                    <li className={`mr-2 hover:text-green-400 ${props.activeTextColor}`}>{props.excoDashboardLabel}</li>
                </Link>
