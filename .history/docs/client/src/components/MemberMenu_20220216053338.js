...
const MemberMenu = (props) => {
    ...
    return(
        <div className="flex mx-auto w-full text-xs md:text-sm lg:text-base justify-around flex-row items-center md:w-4/6 lg:w-5/6 border-y border-y-green-400  md:pl-5">
            <div className={`${props.item} no-underline hover:cursor-pointer hover:no-underline p-2 hover:text-green-500 lg:mr-5`}
            ...
            <div className={`${props.item} text-semibold no-underline hover:cursor-pointer hover:no-underline p-2 hover:text-green-500 lg:mr-5`}
